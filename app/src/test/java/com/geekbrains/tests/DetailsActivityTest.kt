...
class DetailsActivityTest {
    ...
    fun activityCreateIntent_HasCount() {
        val intent = DetailsActivity.getIntent(context, GITHUB_FAKE_REPOSITORY_COUNT)
        val bundle = intent.extras
        assertEquals(GITHUB_FAKE_REPOSITORY_COUNT, bundle?.getInt(DetailsActivity.TOTAL_COUNT_EXTRA, 0))
    }
